                ...
                <div class="wrap--news" v-for="(item,index) in leftBannerDatas">
                    ...
                    <div class="cont--title-bar" @click="getShowDetail(item.postID,index)">
                        ...
                        <div class="wrap--icons" v-if="item.outerLinkUrl !=''">
                            <img :src="'./external-data/images/icons/go_outer.png'" alt="">
                        </div>
                        <div class="wrap--icons" v-else>
                            <img :src="'./external-data/images/icons/go_inner.png'" alt="">
                        </div>
                    </div>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            getNewsPostUrl: function () {
                let vm = this;
                let linkUrl = "./external-data/notice-data.json";
        ...
        filters: {
            ...
            badgeImg: function (value) {
                ...
                switch (value) {
                    case '1':
                        return '../external-data/images/icons/tag-new.png';
                        break;
                    case '2':
                        return '../external-data/images/icons/tag-hot.png';
                        break;
                    case '3':
                        return '../external-data/images/icons/tag-sale.png';
                        break;
                    case '4':
                        return '../external-data/images/icons/tag-update.png';
                        break;
                    default :
                        return '';
                        break;
